# Galaxy Connect™ OpenAPI Specification
[![Build Status](https://travis-ci.org/VictorK/ConnectAPI.svg?branch=master)](https://travis-ci.org/VictorK/ConnectAPI)
...
6. If you did everything correct, https://victork.github.io/ConnectAPI/ will lead to your new docs
...
- Documentation(ReDoc): https://victork.github.io/ConnectAPI/
- SwaggerUI: https://victork.github.io/ConnectAPI/swagger-ui/
- Look full spec:
    + JSON https://victork.github.io/ConnectAPI/swagger.json
    + YAML https://victork.github.io/ConnectAPI/swagger.yaml
- Preview spec version for branch `[branch]`: https://victork.github.io/ConnectAPI/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://victork.github.io/ConnectAPI/ with url from the message: `Server started <url>`
